    ...
    <main className="page">
      ...
      <section className="panel">
        <div className="section-header">
          <h2>Test 列表</h2>
          <button type="button" className="secondary" onClick={() => void loadTests()} disabled={loading || submitting}>
            刷新
          </button>
        </div>
                ...
                {isEditing ? (
                  <div className="item-edit">
                    ...
                    <div className="item-actions">
                      <button type="button" onClick={() => void handleUpdate(item.id)} disabled={submitting}>
                        保存
                      </button>
                  ...
                  <>
                    ...
                    <div className="item-actions">
                      ...
                      <button type="button" className="danger" onClick={() => void handleDelete(item.id)} disabled={submitting}>
                        删除
                      </button>
                    </div>
                  </>
